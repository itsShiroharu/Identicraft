import { resolveUUID, getSkinURL, renderBust, PlayerNotFoundError, MojangRateLimitError } from '../lib/minecraft.js';
...
export default async function handler(req, res) {
  try {
    ...
    const imageBuffer = await renderBust(skinURL, sizeNum);
    ...
    console.error('Bust error:', error);
